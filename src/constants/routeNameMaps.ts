...
export const routeNameBreadcrumbsNameMap: { [key: string]: string } = {
    ...
    [routeNames.user.list]: 'Manage Users',
    [routeNames.user.create]: 'Create New User',
    [routeNames.user.edit('')]: 'Edit User',
    [routeNames.asset.list]: 'Manage Assets',
    [routeNames.asset.create]: 'Create New Asset',
    [routeNames.asset.edit('')]: 'Edit Asset',
    [routeNames.asset.history('')]: 'Assignment History',
    [routeNames.assignment.list]: 'Manage Assignments',
    ...
    [routeNames.returnRequest.list]: 'Manage Return Requests',
...
export const routeNameSidebarNameMap: { [key: string]: SidebarItem } = {
    ...
    [routeNames.asset.history('')]: adminSidebarItems.ManageAsset,
